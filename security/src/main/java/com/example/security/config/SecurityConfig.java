...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("admin").password("$2a$10$zqs6eQwwTToifHGsiMVcruXGgEq6ZK2HA355f1Wym7/R9v3e7XCjS").roles("admin") //配置用户名、密码和角色
                .and()
                .withUser("user").password("$2a$10$iJZFdvEQNcfRbPLWW1Qzhu49ghtCrrnRQOKynEoZT21Y3iM3Z691i").roles("user");
    }
