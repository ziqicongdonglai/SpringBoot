package com.example.generator.hander;

import com.example.generator.enumeration.SexEnum;
...
/**
 * @author ke_zhang
 * @create 2020/4/12 19:26
 * @description 在Money与Long之间转换的TypeHeader，处理CNY人民币
 */
// 声明JdbcType为整形
